...
class GameManager(object):
    ...
    def new_game(self, chat):
        ...
        self.logger.debug("Membuat game baru di obrolan " + str(chat_id))
        game = Game(chat)
    ...
    def join_game(self, user, chat):
        ...
        self.logger.info("Bergabung dengan game dengan id " + str(chat.id))
    ...
    def end_game(self, chat, user):
        ...
        self.logger.info("Permainan dalam obrolan " + str(chat.id) + " berakhir")
